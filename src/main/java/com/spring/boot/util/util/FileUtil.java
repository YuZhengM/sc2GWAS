...
public class FileUtil {
    ...
    public static List<String> listFilename(String path) {
        ...
        return Arrays.stream(list).filter(filename -> new File(path + "/" + filename).isFile()).collect(Collectors.toList());
    }
    ...
    public static List<String> listDirectory(String path) {
        ...
        return Arrays.stream(list).filter(filename -> new File(path + "/" + filename).isDirectory()).collect(Collectors.toList());
    }
    ...
    public static void zipFiles(List<String> srcFiles, String destZipFile) throws IOException {
        try (FileOutputStream fos = new FileOutputStream(destZipFile); ZipOutputStream zipOut = new ZipOutputStream(fos);) {
