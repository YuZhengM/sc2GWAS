...
def get_gene_info(trs_file, name, cell_rate, _type_):
    ...
    values = np.array(csr_matrix(name_data.X).todense()).flatten()
...
if __name__ == '__main__':
    get_gene_info(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4])
